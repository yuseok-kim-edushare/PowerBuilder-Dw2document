$PBExportHeader$nvo_datawindowexporter.sru
forward
global type nvo_datawindowexporter from dotnetobject
end type
end forward
...
global nvo_datawindowexporter nvo_datawindowexporter

type variables

PUBLIC:
String is_assemblypath = "C:\Source\PowerBuilder-Dw2document\bin\net481\yuseok.kim.dw2docs.dll"
String is_classname = "yuseok.kim.dw2docs.Interop.DatawindowExporter"
...
public function string of_exporttoexcel(string as_jsondata,string as_outputpath,string as_sheetname)
public function string of_exporttoword(string as_jsondata,string as_outputpath)
end prototypes
...
Try
	...
	ls_result = This.exporttoexcel(as_jsondata,as_outputpath,as_sheetname)
	Return ls_result
...
Try
	...
	/* Trigger the dotnet function */
	ls_result = This.exporttoword(as_jsondata,as_outputpath)
	Return ls_result
Catch(runtimeerror re_error)
...
on nvo_datawindowexporter.create
call super::create
triggerevent( this, "constructor" )
end on

on nvo_datawindowexporter.destroy
